...
namespace EducationPortalApp.DataAccess.Migrations
{
    ...
    [Migration("20240515190314_InsertUserCourseContentStatusesTable")]
    partial class InsertUserCourseContentStatusesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EducationPortalApp.Entities.CourseEntities.UserCourseContentStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserCourseContentStatuses");
                });
            ...
            modelBuilder.Entity("EducationPortalApp.Entities.CourseEntities.UserCourseContentStatus", b =>
                {
                    b.HasOne("EducationPortalApp.Entities.UserEntities.AppUser", "AppUser")
                        .WithMany("UserCourseContentStatuses")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EducationPortalApp.Entities.CourseEntities.CourseContent", "CourseContent")
                        .WithMany("UserCourseContentStatuses")
            ...
            modelBuilder.Entity("EducationPortalApp.Entities.CourseEntities.CourseContent", b =>
                {
                    b.Navigation("UserCourseContentStatuses");
                });
