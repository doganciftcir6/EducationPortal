...
namespace EducationPortalApp.DataAccess.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "EnrollmentRequestStatuses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EnrollmentRequestStatuses", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseContentTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseContents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseContents_CourseContentTypes_CourseContentTypeId",
                        column: x => x.CourseContentTypeId,
                        principalTable: "CourseContentTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    EnrollmentRequestStatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EnrollmentRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EnrollmentRequests_AspNetUsers_AppUserId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EnrollmentRequests_EnrollmentRequestStatuses_EnrollmentRequestStatusId",
                        column: x => x.EnrollmentRequestStatusId,
                        principalTable: "EnrollmentRequestStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                table: "EnrollmentRequestStatuses",
                columns: new[] { "Id", "Definition" },
                values: new object[,]
                {
                    { 1, "Participation" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseContents_CourseContentTypeId",
                table: "CourseContents",
                column: "CourseContentTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EnrollmentRequests_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EnrollmentRequests_EnrollmentRequestStatusId",
                table: "EnrollmentRequests",
                column: "EnrollmentRequestStatusId");
